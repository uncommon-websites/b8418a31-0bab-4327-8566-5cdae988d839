...
<footer class="bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8 border-t border-gray-100">
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
      ...
      <div>
         <!-- Spacer or other column -->
      </div>
      
      <div>
        <ul class="space-y-3 text-sm font-medium text-gray-900 text-right">
          <li><a href="#" class="hover:text-blue-600">LinkedIn</a></li>
          <li><a href="#" class="hover:text-blue-600">Instagram</a></li>
          <li><a href="#" class="hover:text-blue-600">x.com</a></li>
        </ul>
      </div>
    </div>
